...
BUCKET_PREFIX="cnc-log"   # change this only if you used a different prefix
...
echo "   • Golden Path template with security defaults"
echo "   • Automated CI/CD pipeline with Plan → Review → Apply"
